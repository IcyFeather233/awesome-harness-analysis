...
flowchart LR
  ...
  subgraph g_875bbb6ce75a["ModelCall"]
    direction LR
    n_6327a3e9cdd9["Messages stream<br/>ModelCall"]
  end
  subgraph g_33365285514f["PermissionGate"]
    direction LR
    n_c3d9dc875a4e["Permission gate<br/>PermissionGate"]
  end
  subgraph g_134aeb3c6799["RecoveryPolicy"]
    direction LR
    n_8caa797d111a["Retry and recovery<br/>RecoveryPolicy"]
  end
  subgraph g_0c9b71ca0b61["Router"]
    direction LR
    n_11dec12887d9["Tool execution router<br/>Router"]
  end
  subgraph g_3d2df7742c7e["Session"]
    direction LR
    n_6fad310cfe27["Live session<br/>Session"]
  end
  subgraph g_06fc21210458["Tool"]
    direction LR
    n_2e2b09fcdb36["AgentTool<br/>Tool"]
    n_86fc78b36f0b["Built-in tools<br/>Tool"]
  end
  class n_a0434817a984,n_2fb97928aabe,n_bd9215348ff0,n_4c2f5cbf902d,n_81a313ce89fa,n_9021d26f0f99,n_d82b55feeebb,n_6362d0c51a53,n_d9cf81ae0317,n_6327a3e9cdd9,n_c3d9dc875a4e,n_8caa797d111a,n_11dec12887d9,n_6fad310cfe27,n_2e2b09fcdb36,n_86fc78b36f0b staticOnly;
  n_86fc78b36f0b -.->|"tool_result"| n_bd9215348ff0
  n_86fc78b36f0b -.->|"executes"| n_81a313ce89fa
  n_d82b55feeebb -.->|"enters"| n_4c2f5cbf902d
  n_4c2f5cbf902d -.->|"--print / SDK"| n_d9cf81ae0317
  n_4c2f5cbf902d -.->|"default"| n_6362d0c51a53
  ...
  n_6327a3e9cdd9 -.->|"tool_use"| n_11dec12887d9
  n_c3d9dc875a4e -.->|"authorizes"| n_86fc78b36f0b
  n_c3d9dc875a4e -.->|"model-facing denial"| n_9021d26f0f99
  ...
  n_8caa797d111a -.->|"retries"| n_6327a3e9cdd9
