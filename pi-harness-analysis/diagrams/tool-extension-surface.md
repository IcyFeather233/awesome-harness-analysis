...
flowchart LR
  ...
  subgraph g_f49bb7896ecf["extension"]
    direction LR
    n_adb2aa25686a["Subagent example extension<br/>Plugin"]
  end
  subgraph g_fe18e6d1fb75["governance"]
    direction LR
    n_9b238fc5ebe1["Extension hooks<br/>Hook"]
    n_1606289c70f4["Optional extension gate<br/>PermissionGate"]
  end
  subgraph g_991c9b11fe78["infrastructure"]
    direction LR
    n_6327a3e9cdd9["Provider request<br/>ModelCall"]
  end
  subgraph g_84815bfedb81["observability"]
    direction LR
    n_95a05335b894["Agent events + JSON/RPC<br/>TelemetrySink"]
  end
  subgraph g_6ace60fdd1d9["orchestration"]
    direction LR
  ...
  class n_825e7b7c4e51,n_546fb0dae98a,n_1f48ee0d4fd8,n_3af45ee25e84,n_9b238fc5ebe1,n_6327a3e9cdd9,n_95a05335b894,n_c223520f774e,n_26809c922930 observed;
  class n_66d060a3ce72,n_1606289c70f4,n_adb2aa25686a,n_a17ca7733626 staticOnly;
  ...
  n_adb2aa25686a -.->|"subagent tool"| n_26809c922930
